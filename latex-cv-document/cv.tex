...
\title{Curriculum Vitae -- October 2018}
...
My scientific mission is to intuitively understand and apply tools from nonlinear dynamics, chaos theory 
and deep learning to perform automatic quantification of variability in any context.
\end{changemargin}
...
Single-board computers and microcontrollers (RaspberryPi, BeagleBone,  Arduino and PIC), and 
...
open-source enthusiast at GitHub with my user name \href{https://github.com/mxochicale}{@mxochicale}. 
}
