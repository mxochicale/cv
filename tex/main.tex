...
My reserachs interests are in Ultrasound-guided interventions, Medical Robotics, Human-Robot Interaction, Signal and Image Processing, and Research Software Engineering.
Currently, I am pushing forward the state-of-the-art of ultrasound-guided procedures and am involved in the development of a needle tip tracking system, real-time ultrasound image processing, quality management system for medical devices and public engamenment activities.
All the previous activities in collaboration with renowned clinicians, engineers, QMS specialists, and researchers in KCL and UCL.
...
\begin{itemize}
  ...
  \item In the context of Ultrasound Needle Tracking,
	I am developing validation experiments with linear stages under Windows and GNU/Linux OSs, 
	...
	via GitHub. 
	Simularly, I am contributing quality magement systems of medical devices
	by creating protocols and complying with hardware and sofware standards.  
...
\subsection{King's College London}[London, UK]
\begin{positions}
  \entry{Outreach activities and scientific engagement}{Feb 2020~--~Present}
\end{positions}
\begin{itemize}
...
\begin{itemize}
\item Creation of Artificial Intelligence and Robotics for Children (air4children) a project to teach air to children for free. GitHub: \href{https://github.com/air4children}{\faGithubAlt} Slides: \href{https://github.com/air4children/slides/blob/master/docs/slides/presentation.air4children.pdf}{\faFilePdfO} \printdate{2019--Present} 
