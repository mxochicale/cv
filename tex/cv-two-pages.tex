...
\begin{itemize}
	...
	\item Supervison: Sujon Hekim, in2reserach summer placement
			\textit{Project: AI-based surgical skill assessment using transformer model.}
		\printdate{June 23'~--~Aug 23'}
\end{itemize}
...
\item Co-organised of journal club for computer vision and deep learning at Advanced Research Computing Centre 
	\printdate{01-01-2023 -- present}.
\item Co-organised of activities for SciKit-Surgery tools for the CMICHACKS hackathon: 
