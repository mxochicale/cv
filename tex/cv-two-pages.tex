...
\begin{itemize}
	\item Teaching Associate: AI in Healthcare Group projects. Lecturer: Prof. Paul Taylor \printdate{Jan 23'~--~March 23'}
	\\ I led two group projects on \textit{Fetal Brain Ultrasound Imaging synthesis with Diffusion Models.}
	\item Supervision: Xiaoning Zhu, M.Sc in AI-enabled Healthcare
		\textit{Project: Automatic Medical Image Reporting with transformer-based models.}
		\printdate{Jan 2023~--~Aug 2023}
	\item Supervision: Qingyu Yang, M.Sc. in AI-enabled Healthcare
	...
	\item Supervison: Sujon Hekim, in2reserach summer placement
		\textit{Project: AI-based surgical skill assessment with transformer-based models.}
		\printdate{June 2023~--~Aug 2023}
\end{itemize}
