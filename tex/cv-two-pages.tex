...
\publications{latest-five-publications.bib}
See the full list of publications and associated links \href{https://github.com/mxochicale/cv/blob/main/tex/publications.bib}{(\faExternalLink*)}.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Talks, Posters and Workshops}
\publications{latest-five-talks-and-posters.bib}
See the full list and associated links \href{https://github.com/mxochicale/cv/blob/main/tex/talks-and-posters.bib}{(\faExternalLink*)}.
...
\begin{itemize}
	...
	\item Co-supervision: Kofi Quarshie and Mohamed Mahmoud, in2reserach summer placement
			\textit{Project: Federated learning for eye segmentation.}
			\href{https://blogs.ucl.ac.uk/research-software-development/celebrating-our-in2research-students-at-arc/}{(\faExternalLink*)}
		\printdate{June 26'~--~Aug 26'}

	\item Co-supervision of PhD student Kelechi Imediegwu from the UCL Global Business School for Health
			\textit{Passed Upgrade Viva March 2026}
		\printdate{Oct 25'~--~Sep 27'}
...
% \item Markovito's team was awarded the first place of HOME category at the Mexican Tournament of Robotics 2013, presenting a Human-Robot Interaction Dance Demo \href{https://www.youtube.com/watch?v=Kw-lZam_qZI}{\faYoutube} \printdate{25-27/05/2013}
...
Docker, podman [2024-present],
github container registires [2025-present],
...
\item For the event In2ScienceUK, I shared my scientific journey to young scientists on how they can become better scientist.  
...
\item  Finalist at the Three Minute Thesis Competition 2018. 
	...
	\printdate{05-2018}
\item PhD Research Poster Conference at Uni of Bham 
